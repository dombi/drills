...
- **Implementálás** (kódolás a kész terv alapján, bugfix, apró módosítás):
  a **legtokenhatékonyabb erős modellel** (Gergőnél: **Opus 4.6 vagy 4.8** — `/model claude-opus-4-6`; Opus 5-öt NEM; nem a legdrágább
...
- **KÖTELEZŐ MEGÁLLÓ a terv jóváhagyása után:** ha a jóváhagyás egy tervező
  ...
  kéri a modellváltást: „Terv jóváhagyva. Kódolás előtt válts: `/model claude-opus-4-6` (vagy 4.8)
